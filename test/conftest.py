...
def pytest_configure():
    ...
    pytest.DATASET_PATH = str(this_dir.joinpath("dataset"))
...
def get_file_path():
    def _get_file_path(data_name) -> Tuple[str, str]:
        gro = os.path.join(pytest.DATASET_PATH, data_name,data_name+'.gro')
        top = os.path.join(pytest.DATASET_PATH, data_name,data_name+'.top')
