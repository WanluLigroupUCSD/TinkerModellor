...
def _coord_replace(tk1:TinkerSystem, tk2:TinkerSystem) -> TinkerSystem:
...
def _coord_replace_with_ff(tk1:TinkerSystem, tk2:TinkerSystem, atom_type_addition:int) -> TinkerSystem:
