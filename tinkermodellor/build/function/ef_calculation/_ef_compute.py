...
class ElectricFieldCompute():
    ...
    def __init__(self,charge_method: str = None, tinker_xyz: str = None):
        """
    ...
    def compute_bond_ef(self, bond: List[int], mask:bool = True) -> float:
        ...
        atom1_coord = self.tinker_system_charged.AtomCrds[atom1_idx-1]
        atom2_coord = self.tinker_system_charged.AtomCrds[atom2_idx-1]
